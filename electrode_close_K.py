...
## Immersed boundary
rad = 1
particle_y_offset = 4 * np.pi - 10 * delta_layer - rad
dth = dx / rad
...
ld = loadmat('electrode_close_particle_huge_domain_rad_1_stokes_delta_one_half.mat')
...
for t_step in range(N_t):
   ...
   # ------------------------------------------------------
    ...
    fields = [
        (N_net, 'N_net', [-0.5, 0.5], f'img/electrode/n_net/electrode_close_particle_huge_domain_rad_1_stokes_delta_one_half.png'),
        (Np,    'N_p',   [0,  2], f'img/electrode/n_p/electrode_close_particle_huge_domain_rad_1_stokes_delta_one_half.png'),
        (Nm,    'N_m',   [0,  2], f'img/electrode/n_m/electrode_close_particle_huge_domain_rad_1_stokes_delta_one_half.png'),
    ]
